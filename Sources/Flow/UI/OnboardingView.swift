    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Group {
                ...
                case 3: OnboardShortcutStep(onNext: advance, onBack: goBack)
                case 4: OnboardDoneStep(onFinish: finish)
                default: EmptyView()
                }
            }
...
private struct OnboardChatGPTStep: View {
    ...
    private func handleConnect() {
        loading = true
        coordinator.signIn()
        // Simulate connection for demo; real app would wait for auth callback
...
private struct OnboardDoneStep: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text("ChatFlow lives in your menu bar. Hold **⌥ Space** anywhere to start dictating.")
                .font(.system(size: 16))
                .foregroundColor(.black.opacity(0.52))
                .lineSpacing(6)
                .multilineTextAlignment(.center)
